...
from lab5.domain.object_renderer import ALIGN_CENTER, ALIGN_LEFT, ALIGN_RIGHT
from lab5.domain.state import AppState
from lab5.domain.term_color import InvalidColor, fore, style
from lab5.domain.types import Angle3F, Point3F
